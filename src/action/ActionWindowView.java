...
public class ActionWindowView 
{
	...
	{	
		...
		SashForm leftRightSashForm = new SashForm(window, SWT.HORIZONTAL | SWT.BORDER);
		leftRightSashForm.setLayout(new FillLayout());
		
		// The scrolled Composite that holds the list of actions.
		ScrolledComposite listComposite = new ScrolledComposite(leftRightSashForm, SWT.VERTICAL | SWT.BORDER);
		//listComposite.setExpandVertical(true);
		//Composite listComposite = new Composite(leftRightSashForm, SWT.BORDER);
		//listComposite.setLayout(new FillLayout());
		
		// The list itself.  I cannot figure out yet how to have it fill the scrolled
