...
public class SelectBoxControl implements MouseListener, MouseMotionListener
{
	...
	private float upperleft_x, upperleft_y; // upper left corner x and y of select box
	...
	public void mouseDragged(MouseEvent e) 
	{
		...
		selectbox.setBounds((int) upperleft_x, (int) upperleft_y, (int) width, (int) height);
	 ...
	 * select box.  Right now, it is how the select box gets updated
	 * when the prefuse visualization is zoomed.
	 * 
	 * For some reason, the zoom information is always 1 zoom late...When the 
	 * update is called, the painted values are always the same, so the problem is in the passed values.
	 * 
	 * @param x
	 * @param y
	 * @param width
	...
	/*
      ...
      */  
		selectbox.setBounds((int) upperleft_x, (int) upperleft_y, (int) this.width, (int) this.height);
