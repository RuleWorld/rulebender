...
public class ContactMapLayeredPane extends JLayeredPane
{
  ...
  public Dimension getCMapSize()
  {
    return new Dimension(cMapJPanel.getSize().width
        ...
        - border.getBorderInsets(cMapJPanel).right, cMapJPanel.getSize().height
          ...
          && cMapOverviewJPanel.getComponentCount() > 1)
      {
        ((Display) cMapJPanel.getComponent(0)).setSize(new Dimension(
            currentSize.width - BORDER_WIDTH * 2, currentSize.height
                - BORDER_WIDTH * 2));
        ((Display) cMapOverviewJPanel.getComponent(1)).setBounds(BORDER_WIDTH,
            BORDER_WIDTH, OVERVIEW_WIDTH - BORDER_WIDTH * 3, OVERVIEW_HEIGHT
                - BORDER_WIDTH * 2);
        ((Display) cMapOverviewJPanel.getComponent(1)).setSize(new Dimension(
