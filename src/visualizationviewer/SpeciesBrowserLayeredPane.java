...
public class SpeciesBrowserLayeredPane extends JLayeredPane {
	...
	public Dimension getSpeciesBrowserOverviewSize() {
		return new Dimension(
				speciesBrowserOverviewJPanel.getSize().width
	...
	public void resizeSpeciesBrowser(Dimension size) {
		...
		if (speciesBrowserJPanel != null
			...
			if (speciesBrowserJPanel.getComponentCount() == 1
				...
				((Display) speciesBrowserJPanel.getComponent(0))
						.setSize(new Dimension(currentSize.width - BORDER_WIDTH
								* 2, currentSize.height - BORDER_WIDTH * 2));
				((Display) speciesBrowserOverviewJPanel.getComponent(1))
						.setBounds(BORDER_WIDTH, BORDER_WIDTH, OVERVIEW_WIDTH
