...
class VisualizationViewer extends JFrame
{
  ...
  /**
   * Private constructor for singleton pattern. The constructor instantiates all
   * of the gui elements and packs them into the frame.
   * 
   * @param control_in
   *          This argument is the controller that will be sending events and
   *          commands to the viewer.?
   */
  private VisualizationViewer(VisualizationViewerController control_in)
  {
     ...
     * 
     * // Species Browser overview speciesBrowserOverviewJPanel = new JPanel();
  ...
  protected void setSpeciesBrowser(Display d)
  {
    ...
    /*
     * if(speciesBrowserJPanel.getComponentCount() > 0) { // This should allow
     * the visualization to be garbage collected.
     * speciesBrowserJPanel.removeAll(); //speciesBrowserJPanel.revalidate(); }
     * if(d != null) { speciesBrowserJPanel.add(d, BorderLayout.CENTER);
  ...
  protected void setSpeciesBrowserOverview(Display od)
  {
     ...
     * 
     * // compute the size of select box int x, y, width, height; double ratio;
     ...
     * result[0]; y = (int) result[1]; width = (int) result[2]; height = (int)
     * result[3]; ratio = result[4];
     * 
     ...
     * select box be transparent speciesBrowserRectanglePanel.setOpaque(false);
     ...
     * size_panel.width, size_panel.height); // add overview display to panel
     * speciesBrowserOverviewJPanel.add(speciesBrowserOverview); //
     * speciesBrowserOverviewJPanel.revalidate();
     * 
     * // add mouse listener for select box speciesBrowserSelectBoxControl = new
     * SelectBoxControl(x, y, width, height, speciesBrowserRectanglePanel,
     * dis_focus, ratio); speciesBrowserRectanglePanel
