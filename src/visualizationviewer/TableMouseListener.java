...
public class TableMouseListener implements MouseListener{
	public void mouseClicked(MouseEvent e) {
		...
		String molename = ((String) table.getValueAt(crow, 1)).trim();
		String address = "";

		// column Name
		String columnName = table.getColumnName(ccol);
		
		// UniProt
		if (columnName.equals("UniProt")) {		
			address = "http://www.uniprot.org/uniprot/?query=";
			address += molename;
			address += "&sort=score";
		}
		// HPRD
		else if (columnName.equals("HPRD")) {
