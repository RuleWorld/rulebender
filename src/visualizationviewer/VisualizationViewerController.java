...
public class VisualizationViewerController {
	 ...
	 * user clicks on something that launches the species graph, it is
	 * immediately loaded. This is why you should not load the viewer with
	...
	public Dimension getSpeciesBrowserOverviewSize() {
		return VisualizationViewer.getViewer(this)
	...
	public Visualization getInfluenceGraphVisualization() {
		return VisualizationViewer.getViewer(this)
				.getInfluenceGraphVisualization();
	}
