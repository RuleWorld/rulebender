...
public interface LinkedViewsReceiverInterface {
	...
	/**
	 * Called when a user clicks on a rule in the contact map. The parameter
	 * here has to be a VisualRule because there is not VisualItem for a rule.
	 * 
	 * @param ruleText
	 */
	...
	/**
	 * When the user deselects text. TODO This might not actually be the best
	 * way to interact.
	 */
