...
/**
 * Interactive drag control that is "aggregate-aware", i.e. moves all items in
...
public class AggregateDragControl extends ControlAdapter
{
  ...
  /**
   * Creates a new drag control that drags all items in an aggregate and
   * repaints on drag.
   */
  ...
  /**
   * Creates a new drag control that issues actions as an item is dragged.
   */
