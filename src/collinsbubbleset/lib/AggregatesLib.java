...
public class AggregatesLib {
	 ...
	 *            the aggregate table
	 * @param clusterNumber
	 *            the cluster number to search for
	 * @param field
	 *            the field in the aggregate table where the cluster numbers are
	 *            stored
	 * @return true if and only if the cluster number has already been
	 *         initialized
	 */
	public static boolean clusterExists(AggregateTable at, int clusterNumber,
			String field) {
	 ...
	 *            the aggregate table
	 * @param clusterNumber
	 *            the number of the cluster to retrieve
	 * @param field
	 *            the field in the aggregate table where the cluster numbers are
	 *            stored
	 * @return an AggregateItem with the specified cluster number
	 */
	public static AggregateItem getAItem(AggregateTable at, int clusterNumber,
			String field) {
		IntIterator rows = at.rows();
		while (rows.hasNext()) {
			int row = rows.nextInt();
	 ...
	 */
	public static boolean addTupleToCluster(Tuple t, int clusterNumber,
			String field) {
	 ...
	 * @return whether the first clusternumber in the array has changed
	 */
	public static boolean removeTupleFromCluster(Tuple t, int clusterNumber,
			String field) {
