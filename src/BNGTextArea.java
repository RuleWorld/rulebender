...
public class BNGTextArea extends Composite 
{
	...
	void find()
	{
		...
		findShell.setFont(BNGEditor.globalfont);
		findShell.setText("Find...");
		findShell.setSize(new Point(274, 136));
		findShell.setLayout(null);
		...
		findlabel1.setFont(BNGEditor.globalfont);
		findlabel1.setBounds(new Rectangle(34, 21, 41, 23));
		findlabel1.setFont(new Font(Display.getDefault(), "Segoe UI", 10, SWT.NORMAL));
		findlabel1.setText("Find :");
		findtext1 = new Text(findShell, SWT.BORDER);
		findtext1.setFont(BNGEditor.globalfont);
		findtext1.setBounds(new Rectangle(75, 20, 145, 22));
		...
		findbutton1.setFont(BNGEditor.globalfont);
		findbutton1.setBounds(new Rectangle(33, 57, 57, 25));
		...
		findbutton2.setFont(BNGEditor.globalfont);
		findbutton2.setBounds(new Rectangle(99, 57, 57, 25));
		...
		findbutton3.setFont(BNGEditor.globalfont);
		findbutton3.setBounds(new Rectangle(165, 57, 57, 25));
	...
	void replace()
	{
		...
		replaceShell.setFont(BNGEditor.globalfont);
		replaceShell.setText("Replace...");
		replaceShell.setLayout(null);
		replaceShell.setBounds(new Rectangle(23, 28, 287, 205));
		...
		replacelabel1.setFont(BNGEditor.globalfont);
		replacelabel1.setBounds(new Rectangle(38, 23, 51, 20));
		replacelabel1.setFont(new Font(Display.getDefault(), "Segoe UI", 10, SWT.NORMAL));
		replacelabel1.setText("Find:");
		Label replacelabel2 = new Label(replaceShell, SWT.NONE);
		replacelabel2.setFont(BNGEditor.globalfont);
		replacelabel2.setBounds(new Rectangle(38, 57, 51, 18));
		replacelabel2.setText("Replace:");
		replacetext1 = new Text(replaceShell, SWT.BORDER);
		replacetext1.setFont(BNGEditor.globalfont);
		replacetext1.setBounds(new Rectangle(94, 21, 141, 24));
		...
		replacetext2.setFont(BNGEditor.globalfont);
		replacetext2.setBounds(new Rectangle(94, 54, 141, 24));
		...
		replacebutton1.setFont(BNGEditor.globalfont);
		replacebutton1.setBounds(new Rectangle(44, 93, 88, 23));
		...
		replacebutton2.setFont(BNGEditor.globalfont);
		replacebutton2.setBounds(new Rectangle(139, 93, 88, 23));
		...
		replacebutton3.setFont(BNGEditor.globalfont);
		replacebutton3.setBounds(new Rectangle(44, 124, 88, 23));
		...
		replacebutton4.setFont(BNGEditor.globalfont);
		replacebutton4.setBounds(new Rectangle(139, 124, 88, 23));
