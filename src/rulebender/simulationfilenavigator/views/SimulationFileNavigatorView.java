package rulebender.simulationfilenavigator.views;
...
import rulebender.simulationfilenavigator.actions.RefreshAction;

public class SimulationFileNavigatorView extends ViewPart {
	...
	public SimulationFileNavigatorView() 
	{
	...
	public void createPartControl(Composite parent) 
	{
		...
		// Don't want to open anything from this.
	    ...
	    menuMgr.addMenuListener(new IMenuListener() 
		    {
		        ...
		        {
		            SimulationFileNavigatorView.this.fillContextMenu(manager);
		        }
		    });
