...
import rulebender.results.navigator.actions.RefreshAction;

public class ResultsNavigatorView extends ViewPart {
	...
	public void createPartControl(Composite parent) 
	{
		...
		m_treeViewer.addDoubleClickListener(new ReusltsNavigatorDoubleClickListener());
	    ...
	    menuMgr.addMenuListener(new IMenuListener() 
		    {
		        ...
		        {
		            ResultsNavigatorView.this.fillContextMenu(manager);
		        }
		    });
