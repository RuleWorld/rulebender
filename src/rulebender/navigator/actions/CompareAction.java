...
public class CompareAction extends Action 
{
	...
	private static final ImageDescriptor m_deleteImage = ImageDescriptor.createFromImage(AbstractUIPlugin.imageDescriptorFromPlugin ("rulebender","/icons/views/compare.png").createImage());
