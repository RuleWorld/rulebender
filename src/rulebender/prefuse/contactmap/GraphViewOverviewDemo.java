 ...
 * @author Juanjo Vega
 */
public class GraphViewOverviewDemo extends JPanel {
    ...
    public GraphViewOverviewDemo(Graph g, String label) {
        ...
        // overview display
        Overview overview = new Overview(display);
    ...
    public static JFrame demo(Graph g, String label) {
        final GraphViewOverviewDemo view = new GraphViewOverviewDemo(g, label);
    ...
    public abstract static class GraphMenuAction extends AbstractAction {
        ...
        private GraphViewOverviewDemo m_view;

        public GraphMenuAction(String name, String accel, GraphViewOverviewDemo view) {
            m_view = view;
    ...
    public static class OpenGraphAction extends AbstractAction {
        ...
        public OpenGraphAction(GraphViewOverviewDemo view) {
            m_view = view;
