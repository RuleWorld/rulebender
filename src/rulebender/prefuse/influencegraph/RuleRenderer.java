package rulebender.prefuse.influencegraph;
...
public class RuleRenderer extends AbstractShapeRenderer {
    ...
    /**
     * Create a new RuleRenderer. By default the field "label" is used
    ...
    /**
     * Create a new RuleRenderer. Draws a text label using the given
    ...
    /**
     * Create a new RuleRenderer. Draws a text label using the given text
