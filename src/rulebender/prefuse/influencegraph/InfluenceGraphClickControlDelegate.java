...
public class InfluenceGraphClickControlDelegate extends ControlAdapter implements LinkedViewsReceiverInterface
{
...
//	private VisualizationViewerController visviewer;
	...
	public void ruleSelectedInContactMap(VisualRule rule) 
	{
		...
		// So when a rule is selected in the contact map, if it is bidirectional then we need to look for r -> p or p->r
	...
	private void selectRuleFromText(String ruleText, boolean reset)
	{
		...
		String reverse = forward.substring(forward.indexOf('>')+1, forward.length()) + 
