...
public class SmallMultiple {
	 ...
	 * 
	 * @param view
	 *          - SmallMultiplesView that the SmallMultiple will be loaded into
	 * @param model_in
	 *          - ContactMapModel that we're converting to a visual representation
	 * @param cMapSize
	 *          - Size bounds of the ContactMap
	 * @param layoutPath
	 *          - Layout we're passing along to the CMAPNetworkViewer
	 */
	public SmallMultiple(SmallMultiplesView view, ContactMapModel model_in,
	    Dimension cMapSize, String layoutPath) {
		...
		SMClickControlDelegate smctrldelegate = new SMClickControlDelegate(view,
		...
		// size.setRect(0,0,m_mainDisplaySize.width,m_mainDisplaySize.height);

		// DisplayLib.fitViewToBounds(this,
		// getDisplay().getBounds(Visualization.ALL_ITEMS), 0);
