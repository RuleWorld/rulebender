package rulebender.speciesgraph.prefuse;
...
import rulebender.speciesgraph.data.Species;
import rulebender.speciesgraph.view.SpeciesGraphClickControlDelegate;

public class SpeciesGraphVisual {
	...
	public SpeciesGraphVisual(int id, String speciesExp, Dimension mainDimension) 
	{
