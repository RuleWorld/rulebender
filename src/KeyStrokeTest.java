...
public class KeyStrokeTest  
{
	...
	private static void match(String patternString, String string)
	{
        ...
        while (matcher.find()) 
        {
           System.out.println("\nI found the text "+matcher.group()+" starting at " +
	...
	private static void keyStrokes()
	{
		...
		//System.out.println("AWT KeyStroke: " + 
			//	KeyStroke.getKeyStroke(KeyEvent.VK_Q, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()).getKey);
		
		System.out.println("\\nSWT Mod + C: " + (SWT.MOD1 + 'C'));
		System.out.println("AWT KeyStroke: " + 
				KeyStroke.getKeyStroke(KeyEvent.VK_C, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()).getKeyCode());
		
		System.out.println("\\nSWT Mod + V: " + (SWT.MOD1 + 'V'));
		System.out.println("AWT KeyStroke: " + 
				KeyStroke.getKeyStroke(KeyEvent.VK_V, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()).getKeyCode());
		
		System.out.println("\\nSWT Mod + Z: " + (SWT.MOD1 + 'Z'));
		System.out.println("AWT KeyStroke: " + 
				KeyStroke.getKeyStroke(KeyEvent.VK_Z, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()).getKeyCode());
