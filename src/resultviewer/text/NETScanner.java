...
public class NETScanner extends RuleBasedScanner
{
  ...
  private static String[] words = { "begin", "end", "parameters", "molecule",
      "Molecules", "types", "observables", "species", "Species", "reaction",
      "reactions", "rules", "reaction_rules", "groups", "rates",
      "reaction_rates", "MatchOnce", "substanceUnits", "setOption", "model",
      "generate_network", "setConcentration", "resetConcentrations",
      "saveConcentrations", "writeSBML", "writeMfile", "simulate_ode",
      "simulate_ssa", "compartments" };
  ...
  public static RuleBasedScanner getCommentScanner()
  {
    RuleBasedScanner scanner = new RuleBasedScanner();
    scanner
        .setDefaultReturnToken(new Token(new TextAttribute(color_PaleGreen4)));
    return scanner;
  }
}
