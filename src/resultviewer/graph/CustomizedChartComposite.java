 ...
 */
public class CustomizedChartComposite extends Composite implements ChartChangeListener,
     ...
     */
    public CustomizedChartComposite(Composite comp, int style) {
        this(comp,
                style,
                null,
                DEFAULT_WIDTH,
     ...
     */
    public CustomizedChartComposite(Composite comp, int style, JFreeChart chart) {
        this(comp,
             style,
             chart,
             DEFAULT_WIDTH,
     ...
     */
    public CustomizedChartComposite(
            Composite comp,
            int style,
            JFreeChart chart,
            boolean properties,
     ...
     *                  enabled for the chart.
     */
    public CustomizedChartComposite(Composite comp,
            int style,
...
//          this.canvas.addMouseWheelListener((MouseWheelListener) listener);
    ...
    public void mouseUp(MouseEvent event) {
        ...
        if (this.zoomRectangle == null) {
            ...
            // modified by Wen Xu on March 22, 2011
            // add support for ctrl+left click represents right click under Mac
            // original code
            /*
            ...
            */
            ...
            // new code
            if (this.popup != null) {
            	if(event.button == 3 || (event.button == 1 && (event.stateMask & SWT.CTRL) != 0)) {
            		org.eclipse.swt.graphics.Point pt = this.canvas.toDisplay(
                            event.x, event.y);
                    displayPopupMenu(pt.x, pt.y);
            	}
