...
public class ForceDirectedLayoutMagic extends Layout
{
   ...
   * restrict the layout to the layout bounds and will assume it is being run in
  ...
  public void run(double frac)
  {
    ...
    if (m_runonce)
    {
       ...
       * 
       * while (iter.hasNext()) { VisualItem item = (NodeItem) iter.next();
       * item.setX(anchor.getX()); item.setY(anchor.getY()); }
       */
  ...
  protected void initSimulator(ForceSimulator fsim)
  {
    ...
    if (m_edgeGroup != null)
    {
      ...
      while (iter.hasNext())
      {
        ...
        fsim.addSpring(f1, f2, (coeff >= 0 ? coeff : -1.f), (slen >= 0 ? slen
            : -1.f));
      }
    }
  }
