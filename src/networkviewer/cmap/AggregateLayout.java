...
public class AggregateLayout extends Layout
{
  ...
  /**
   * @see edu.berkeley.guir.prefuse.action.Action#displayNewVersionOptions(edu.berkeley.guir.prefuse.ItemRegistry,
   *      double)
   * 
  ...
  public void run(double frac)
  {
    ...
    // update buffers. Make an array that will hold x and y points for each
    // corner
    // of the visual item.
    int maxsz = 0;
