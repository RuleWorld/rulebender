 ...
 */
public class DeterministicSpringForce extends AbstractForce {
	 ...
	 */
	public DeterministicSpringForce(float springCoeff, float defaultLength) {
		params = new float[] { springCoeff, defaultLength };
		minValues = new float[] { DEFAULT_MIN_SPRING_COEFF,
				DEFAULT_MIN_SPRING_LENGTH };
		maxValues = new float[] { DEFAULT_MAX_SPRING_COEFF,
	 ...
	 */
	public DeterministicSpringForce() {
