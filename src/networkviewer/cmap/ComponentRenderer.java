 ...
 */
public class ComponentRenderer extends AbstractShapeRenderer
{
   ...
   */
  public ComponentRenderer(String textField)
  {
   ...
   *          be drawn.
   */
  public ComponentRenderer(String textField, String imageField)
  {
