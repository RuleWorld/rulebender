...
public abstract class HoverTooltip extends ControlAdapter
{
  ...
  protected abstract void showNodeTooltip(VisualItem item,
      java.awt.event.MouseEvent e); /*
                                     ...
                                     * 
                                     * (Display)e.getSource(), ((prefuse.data
                                     * .Node)v.getSourceTuple(item
                                     * )).getString("name"), ((prefuse.data.Node
                                     * )v.getSourceTuple(item
                                     * )).getString("gender")), item, e);
                                     * 
                                     * 
                                     * }
                                     */
  ...
  protected abstract void showEdgeTooltip(VisualItem item,
      java.awt.event.MouseEvent e);


  /*
   * { Visualization v = item.getVisualization(); Edge edge =
   * (prefuse.data.Edge)v.getSourceTuple(item); String connector;
   * 
   * if(edge.isDirected()) { connector = " -> "; } else { connector = " - "; }
   * 
   * showTooltip(new InterlinkenEdgeTooltip( (Display)e.getSource(),
   * edge.getSourceNode().getString("name") + connector +
   * edge.getTargetNode().getString("name")), item,
   * 
   * e); }
   */
