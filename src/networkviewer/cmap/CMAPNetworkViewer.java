...
public class CMAPNetworkViewer
{
   ...
   * renderer factory, which decides which renderer to use for each visual item
   * based on whether it is a node or edge. Can do more things with predicates
   * and create new renderers for advanced rendering.
   */
  ...
  private void setUpActions()
  {
    ...
    int[] palette = new int[] { ColorLib.rgba(254, 224, 139, 150),
        ColorLib.rgba(166, 217, 106, 150), ColorLib.rgba(253, 174, 97, 150),
        ColorLib.rgba(240, 240, 240, 150), ColorLib.rgba(153, 112, 171, 150),
