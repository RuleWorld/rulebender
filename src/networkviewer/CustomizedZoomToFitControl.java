 ...
 */
public class CustomizedZoomToFitControl extends ControlAdapter
{
   ...
   */
  public CustomizedZoomToFitControl()
  {
  }
   ...
   */
  public CustomizedZoomToFitControl(String group)
  {
    this.m_group = group;
  }
   ...
   */
  public CustomizedZoomToFitControl(int button)
  {
   ...
   *          {@link Control#RIGHT_MOUSE_BUTTON}.
   */
  public CustomizedZoomToFitControl(String group, int button)
  {
    this.m_group = group;
    this.m_button = button;
  }
   ...
   *          the data group that should fit the Display
   * @param margin
   *          the margin, in pixels, desired between the group and the edge of
   *          the display
   * @param duration
   ...
   *          {@link Control#RIGHT_MOUSE_BUTTON}.
   */
  public CustomizedZoomToFitControl(String group, int margin, long duration,
      int button)
  {
    this.m_group = group;
