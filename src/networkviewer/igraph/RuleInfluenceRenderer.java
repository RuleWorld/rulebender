...
public class RuleInfluenceRenderer extends AbstractShapeRenderer {
    ...
    protected Shape getRawShape(VisualItem item) {
        ...
        /*
        //set end point based on edge influence type
        Integer activate = (Integer)edge.get("activation");
        Integer inhibit = (Integer)edge.get("inhibition");
        ...
        if (inhibit == 1 || inhibit == 0) {
        	m_xAlign2 = Constants.RIGHT;
