...
public abstract class PrefuseTooltip {
	...
	public PrefuseTooltip(javax.swing.JComponent owner, int startDelay,
			int stopDelay) {
		this.owner = owner;
		...
		startShowingTimer = new javax.swing.Timer(startDelay,
				new ShowTimerAction(true));
		stopShowingTimer = new javax.swing.Timer(stopDelay,
				new ShowTimerAction(false));
