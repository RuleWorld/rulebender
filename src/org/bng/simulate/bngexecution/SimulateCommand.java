...
public class SimulateCommand implements CommandInterface {
	...
	/**
	 * Constructor for a Simulation Command. Create the object, and then call
	 * the getCommand() method to get the string of the command to execute.
	 * 
	 * @param bngFile
	 *            - The string location of the file to run the scan on.
	 */
	public SimulateCommand(String bngFile, String bngFullPath,
			String resultsDirectory, boolean viewResults) {
		m_bnglFile = bngFile;
