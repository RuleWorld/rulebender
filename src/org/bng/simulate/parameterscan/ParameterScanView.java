      ...
      final Composite parent)
  {
    ...
    okButton.addSelectionListener(new SelectionListener()
    {
      ...
      public void widgetSelected(SelectionEvent arg0)
      {
        ...
        /*
         * String[] psresult = new String[1]; psresult[0]=prefix+".scan";
         * if(!stemp2.contains("open") && !stemp2.contains("ABORT") &&
         * !stemp2.contains("line")) { try {
         * 
         * new Viewer(null,psresult,new String[0]); } catch (IOException e) {} }
         */
