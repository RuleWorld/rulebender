...
public class ParameterScanCommand implements CommandInterface {
	...
	/**
	 * Constructor for a ParameterScanCommand. Create the object, and then call
	 * the getCommand() method to get the string of the command to execute.
	 * 
	 * @param bngFile
	 *            - The string location of the file to run the scan on.
	 * @param parScanScriptLocation
	 *            - The string location of the perl script that runs the scan.
	 * @param resultsDirectory
	 *            - Where the results will go: used for the construction of the
	 *            prefix.
	 * @param data
	 *            - The object that holds all of the parameterscandata.
	 */
	public ParameterScanCommand(String bngFile, String bngFullPath,
			String parScanScriptLocation, String resultsDirectory,
	 ...
	 * parameter being scanned, and the files that are already in the results
	 * directory.
	 * 
