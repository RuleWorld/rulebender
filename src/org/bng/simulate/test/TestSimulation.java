...
public class TestSimulation 
{
	...
	public void testR597SimulationNoSpace()
	{
		...
		// no spaces
		//BioNetGenUtility.runBNGLFile(modelPathNoSpace, bngR597PathNoSpace, resultsPathNoSpace);
		
		// Space in model path
		BioNetGenUtility.runBNGLFile(modelPathSpace, bngR597PathNoSpace, resultsPathNoSpace);
