...
public class CommandRunner<T extends CommandInterface> 
{
	...
	public boolean run() throws SimulationErrorException 
	{
		...
		System.out.println("Using BNGFullPath: " + m_command.getBNGFullPath().substring(0, m_command.getBNGFullPath().lastIndexOf(System.getProperty("file.separator"))));
		
		 ProcessBuilder pb = new ProcessBuilder(m_command.getCommand());
		 Map<String, String> env = pb.environment();
		 env.put("CYGWIN", "nodosfilewarning");
		 env.put("BNGPATH",  m_command.getBNGFullPath().substring(0, m_command.getBNGFullPath().lastIndexOf(System.getProperty("file.separator"))));
		 //env.remove("OTHERVAR");
