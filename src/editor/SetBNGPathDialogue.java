			...
			public void widgetSelected(SelectionEvent arg0) {
				...
				while (completedPath.substring(completedPath.length() - 1,
						...
						|| completedPath.substring(completedPath.length() - 1,
								completedPath.length()).equals("/")) {
					completedPath = completedPath.substring(0,
				...
				// Good to go!
					...
					if (ConfigurationManager.getConfigurationManager()
						...
						ConfigurationManager.getConfigurationManager()
								.setBNGFPath(
										completedPath
												.substring(0, completedPath
														.lastIndexOf('\\')));
						ConfigurationManager
								.getConfigurationManager()
								.setBNGFName(
										completedPath.substring(
												completedPath.lastIndexOf('\\') + 1,
												completedPath.length()));
					} else {
						ConfigurationManager
								.getConfigurationManager()
								.setBNGFPath(
										completedPath.substring(0,
												completedPath.lastIndexOf('/')));
						ConfigurationManager
								.getConfigurationManager()
								.setBNGFName(
										completedPath.substring(
