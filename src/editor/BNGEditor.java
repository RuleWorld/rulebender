...
public class BNGEditor
{
  ...
  private static LinkHub actionHub;

  private static String m_lineDelimiter;
  ...
  /**
   * Basically everything in this method is for setting up menus, buttons, and
   * the appropriate actionListeners and activities. -ams
   */
  private void createSShell()
  {
    ...
    actionHub = LinkHub.getLinkHub();
  }


  /**
   * Constructs the menu bar. Appears at the top of the screen for osx, or below
   * the titlebar linux and windows.
   * 
   */
  private void setupMenuBar()
  {
    Menu menuBar = new Menu(mainEditorShell, SWT.BAR);
     ...
     * mtr4.setText("&Parameter Scan"); mtr4.addSelectionListener(new
     * org.eclipse.swt.events.SelectionListener() { public void
     * widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
     * if(textfolder.getSelection() == null) return;
     * inputfiles.get(fileselection).parscan(); } public void
    ...
    mo1.addSelectionListener(new org.eclipse.swt.events.SelectionListener()
    {
      ...
      public void widgetSelected(org.eclipse.swt.events.SelectionEvent e)
      {
        ...
        if (fontData != null)
        {
          ...
          getInputfiles().get(getFileselection()).getBNGTextArea()
              .getStyledTextArea().setFont(font);
          getInputfiles().get(getFileselection()).getBNGTextArea().arc1
              .redraw();
          getInputfiles().get(getFileselection()).getBNGTextArea().arc2
              .redraw();
        }
      }
    ...
    // SWT.MOD1, the first modifier, is set to SWT.CONTROL on Windows and to
    // SWT.COMMAND on the Mac
    ...
    mte1.addSelectionListener(new org.eclipse.swt.events.SelectionListener()
    {
      ...
      public void widgetSelected(org.eclipse.swt.events.SelectionEvent e)
      {
        if (textfolder.getSelection() == null)
          return;
        getInputfiles().get(getFileselection()).getBNGTextArea().Undo();
      }
    ...
    mte2.addSelectionListener(new org.eclipse.swt.events.SelectionListener()
    {
      ...
      public void widgetSelected(org.eclipse.swt.events.SelectionEvent e)
      {
        if (textfolder.getSelection() == null)
          return;
        getInputfiles().get(getFileselection()).getBNGTextArea().cut();
      }
    ...
    // mte3.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C,
    ...
    mte3.addSelectionListener(new org.eclipse.swt.events.SelectionListener()
    {
      ...
      public void widgetSelected(org.eclipse.swt.events.SelectionEvent e)
      {
        if (textfolder.getSelection() == null)
          return;
        getInputfiles().get(getFileselection()).getBNGTextArea().copy();
      }
    ...
    mte4.addSelectionListener(new org.eclipse.swt.events.SelectionListener()
    {
      ...
      public void widgetSelected(org.eclipse.swt.events.SelectionEvent e)
      {
        if (textfolder.getSelection() == null)
          return;
        getInputfiles().get(getFileselection()).getBNGTextArea().paste();
      }
    ...
    mte5.addSelectionListener(new org.eclipse.swt.events.SelectionListener()
    {
      ...
      public void widgetSelected(org.eclipse.swt.events.SelectionEvent e)
      {
        if (textfolder.getSelection() == null)
          return;
        getInputfiles().get(getFileselection()).getBNGTextArea().find();
      }
    ...
    mte6.addSelectionListener(new org.eclipse.swt.events.SelectionListener()
    {
      ...
      public void widgetSelected(org.eclipse.swt.events.SelectionEvent e)
      {
        if (textfolder.getSelection() == null)
          return;
        getInputfiles().get(getFileselection()).getBNGTextArea().replace();
      }
    ...
    mte7.addSelectionListener(new org.eclipse.swt.events.SelectionListener()
    {
      ...
      public void widgetSelected(org.eclipse.swt.events.SelectionEvent e)
      {
        if (textfolder.getSelection() == null)
          return;
        getInputfiles().get(getFileselection()).getBNGTextArea().selectall();
      }
     ...
     * mte8.setText("&Delete All\tCtrl+D"); mte8.setAccelerator(SWT.MOD1 + 'D');
     * mte8.addSelectionListener(new org.eclipse.swt.events.SelectionListener()
     * { public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
     * if(textfolder.getSelection() == null) return;
     * inputfiles.get(fileselection).getStyledTextArea().deleteall(); } public
    ...
    newFileMenuItem
        .addSelectionListener(new org.eclipse.swt.events.SelectionListener()
        {
          ...
          public void widgetSelected(org.eclipse.swt.events.SelectionEvent e)
          {
            NewFileDialogue newfilediag = new NewFileDialogue(mainEditorShell,
                tempthis);
            newfilediag.show();
          }
      ...
      public void widgetSelected(org.eclipse.swt.events.SelectionEvent e)
      {
        ...
        for (int i = 0; i < getInputfiles().size(); i++)
          if (getInputfiles().get(i).tabitem.equals(textfolder.getSelection()))
          {
            ...
            visViewController.fileBecomesFocus(getInputfiles().get(
                getFileselection()));
        ...
        if (getInputfiles().get(getFileselection()).getFilepath() == null)
          getShowfilepath().setText("");
        else if (ConfigurationManager.getConfigurationManager().getOSType() == 1)
          getShowfilepath().setText(
              getInputfiles().get(getFileselection()).getFilepath() + "\\"
                  + getInputfiles().get(getFileselection()).getFileName());
        else
          getShowfilepath().setText(
              getInputfiles().get(getFileselection()).getFilepath() + "/"
                  + getInputfiles().get(getFileselection()).getFileName());
    ...
    mtf9.addSelectionListener(new org.eclipse.swt.events.SelectionListener()
    {
      ...
      public void widgetSelected(org.eclipse.swt.events.SelectionEvent e)
      {
        ...
        if (printer == null)
          printer = new Printer();
        getInputfiles().get(getFileselection()).getBNGTextArea()
            .getStyledTextArea().print(printer).run();
      }
    ...
    mtf6.setText("E&xit");
    mtf6.setAccelerator(SWT.MOD1 + 'Q');
    // mtf6.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q,
    // Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()).getKeyCode());
    ...
    mainEditorShell.addListener(SWT.Close, new Listener()
    {

      @Override
      public void handleEvent(Event arg0)
      {
        System.out.println("SWT.Close");
        cleanupAndQuit();

      }
    });
    mainEditorShell.addShellListener(new org.eclipse.swt.events.ShellAdapter()
    {
  ...
  private void cleanupAndQuit()
  {
    ...
    // VisualizationViewerController.quitting();
  ...
  {
    getKeywords().add(
        Pattern.compile("\\s+(begin[ \\t\\x0B\\f]+parameters)[#\\s]")); // 1
    getKeywords().add(
        Pattern.compile("\\s+(end[ \\t\\x0B\\f]+parameters)[#\\s]")); // 2
    getKeywords().add(
        Pattern.compile("\\s+(begin[ \\t\\x0B\\f]+functions)[#\\s]")); // 3
    getKeywords().add(
        Pattern.compile("\\s+(end[ \\t\\x0B\\f]+functions)[#\\s]")); // 4
    getKeywords()
        .add(
            Pattern
                .compile("\\s+(begin[ \\t\\x0B\\f]+molecule([ \\t\\x0B\\f]+|_)types)[#\\s]")); // 5
    getKeywords()
        .add(
            Pattern
                .compile("\\s+(end[ \\t\\x0B\\f]+molecule([ \\t\\x0B\\f]+|_)types)[#\\s]")); // 6
    getKeywords().add(
        Pattern.compile("\\s+(begin[ \\t\\x0B\\f]+compartments)[#\\s]")); // 7
    getKeywords().add(
        Pattern.compile("\\s+(end[ \\t\\x0B\\f]+compartments)[#\\s]")); // 8
    getKeywords()
        .add(
            Pattern
                .compile("\\s+(begin[ \\t\\x0B\\f]+(seed([ \\t\\x0B\\f]+|_))?species)[#\\s]")); // 9
    getKeywords()
        .add(
            Pattern
                .compile("\\s+(end[ \\t\\x0B\\f]+(seed([ \\t\\x0B\\f]+|_))?species)[#\\s]")); // 10
    getKeywords().add(
        Pattern.compile("\\s+(begin[ \\t\\x0B\\f]+observables)[#\\s]")); // 11
    getKeywords().add(
        Pattern.compile("\\s+(end[ \\t\\x0B\\f]+observables)[#\\s]")); // 12
    getKeywords()
        .add(
            Pattern
                .compile("\\s+(begin[ \\t\\x0B\\f]+reaction([ \\t\\x0B\\f]+|_)rules)[#\\s]")); // 13
    getKeywords()
        .add(
            Pattern
                .compile("\\s+(end[ \\t\\x0B\\f]+reaction([ \\t\\x0B\\f]+|_)rules)[#\\s]")); // 14
    getKeywords().add(
        Pattern.compile("\\s+(begin[ \\t\\x0B\\f]+actions)[#\\s]")); // 15
  ...
  private void createToolBar()
  {
    ...
    ArrayList<ActionInterface> toolBarActions = ToolBarActionListCreator
        .getActionItems();
     ...
     * actionButton.setText("Actions"); actionButton.setEnabled(true);
     * actionButton.addSelectionListener(new SelectionListener() { public void
     * widgetSelected(SelectionEvent e) { if(textfolder.getSelection() == null)
     * return;
     * 
     * // System.out.println("Action Hot Dog Go");
     * 
     * Menu actionMenu = new Menu(getMainEditorShell(), SWT.DROP_DOWN); MenuItem
     * test = new MenuItem(actionMenu, SWT.PUSH); test.setText("test");
     ...
     * toolItem4.setText("Visualize"); toolItem4.setEnabled(true);
     * toolItem4.addSelectionListener(new SelectionListener() { public void
     * widgetSelected(SelectionEvent e) { if(textfolder.getSelection() == null)
     * return;
     * 
     * //BNGEditor.getEditor().getInputFiles().get(BNGEditor.getEditor().
     * getFileSelection()).produceNewModels(); //VisualizationViewer.getViewer
     * ().fileSelectionChange(BNGEditor.getEditor
     * ().getInputFiles().get(BNGEditor.getEditor().getFileSelection()));
     * //VisualizationViewer.getViewer().setVisible(true);
     * 
     * visViewController.openVisualizationViewerFrame();//inputfiles.get(
     * fileselection));
     * 
     * } public void widgetDefaultSelected(org.eclipse.swt.events.SelectionEvent
     * e) {} });
  ...
  private void setupEditorContextMenu()
  {
    ...
    // MenuItem linkSeparator = new MenuItem(getPopmenu(), SWT.SEPARATOR);

    // MenuItem selectMolecule = new MenuItem(getPopmenu(), SWT.PUSH);
    // selectMolecule.setText("Select Molecule");

    /*
     * // TODO definitely can set more advanced checking here to see if the
     * selected text is a // molecule or rule. if(!getInputFiles().isEmpty() &&
     * !getInputfiles().get(getFileselection()).getBNGTextArea().
     * getStyledTextArea().getSelectionText().equals("")) {
     * selectMolecule.setEnabled(true); } else {
     * selectMolecule.setEnabled(false); }
     */
    /*
     * selectMolecule.addSelectionListener(new
     * org.eclipse.swt.events.SelectionListener() { // The method that is called
     * when the menu item is selected. public void
     * widgetSelected(org.eclipse.swt.events.SelectionEvent e) { // If there are
     * no open files, then do nothing. if(textfolder.getSelection() == null)
     * return;
     * 
     * // Get the selected text. String selected =
     * getInputfiles().get(getFileselection
     * ()).getBNGTextArea().getStyledTextArea().getSelectionText();
     * 
     * // TODO this is going to be slower than necessary until we parse to make
     * sure // that it is a valid molecule before we send it.
     * LinkHub.getLinkHub().moleculeSelectedInText(selected);
     * 
     * } public void widgetDefaultSelected(org.eclipse.swt.events.SelectionEvent
     * e) { } });
     */
    // MenuItem selectRule = new MenuItem(getPopmenu(), SWT.PUSH);
    // selectRule.setText("Select Rule");
     ...
     * !getInputfiles().get(getFileselection()).getBNGTextArea().
     * getStyledTextArea().getSelectionText().equals("")) {
     * selectRule.setEnabled(true); } else { selectRule.setEnabled(false); }
     */
    /*
     * selectRule.addSelectionListener(new
     * org.eclipse.swt.events.SelectionListener()
     * 
     * { // The method that is called when the menu item is selected. public
     * void widgetSelected(org.eclipse.swt.events.SelectionEvent e) { // If
     * there are no open files, then do nothing. if(textfolder.getSelection() ==
     * null) return;
     * 
     * // Get the selected text. String selected =
     * getInputfiles().get(getFileselection
     ...
     * // TODO this is going to be slower than necessary until we parse to make
     * sure // that it is a valid molecule before we send it.
     * LinkHub.getLinkHub().ruleSelectedInText(selected);
     * 
     * } public void widgetDefaultSelected(org.eclipse.swt.events.SelectionEvent
     * e) { } });
     */
  ...
  private void createTextfolder()
  {
    ...
    textfolder.addMouseListener(new MouseListener()
    {
      ...
      public void mouseDoubleClick(MouseEvent arg0)
      {
        ...
        CurrentFile tempfile = new CurrentFile(null, filename,
  ...
  private void createConsole()
  {
    ...
    console = new Text(consoleGroup, SWT.MULTI | SWT.BORDER | SWT.WRAP
        | SWT.V_SCROLL);
    console.setEditable(false);
    console.setBackground(new Color(Display.getCurrent(), 255, 255, 255));
    m_lineDelimiter = console.getLineDelimiter();
  }
  ...
  public static void main(String[] args)
  {
    ...
    BNGEditor.mainEditorShell.open();
    init();

    PreReqChecker.checkForPerl();

    // DEBUG
    // BNGEditor.displayOutput("User Dir = " +
    // System.getProperty("user.dir")+BNGEditor.getConsoleLineDelimeter());
    ...
    while (!BNGEditor.mainEditorShell.isDisposed())
    {
  ...
  static void init()
  {
    ...
    textfolder.addSelectionListener(new SelectionAdapter()
    {
      ...
      public void widgetSelected(SelectionEvent arg0)
      {
        ...
        ParameterScanController psController = ParameterScanController
            .getParameterScanController();
        psController.fileSelectionChange(getInputfiles()
            .get(getFileselection()));
      }
    });
    ...
    textfolder.addCTabFolder2Listener(new CTabFolder2Adapter()
    {
      ...
      public void close(CTabFolderEvent arg0)
      {
        ...
        if (getFileselection() == -1
            || getFileselection() >= getInputfiles().size())
        {
          setFileselection(-1);
          getShowfilepath().setText("");
          visViewController.fileBecomesFocus(null);
  ...
  {
    /*
     * // slash for different operating system String tmpSlash = "";
     * if(ConfigurationManager.getConfigurationManager().getOSType() == 1) {
     * tmpSlash = "\\"; } else { tmpSlash = "/"; }
     * 
     * // parentDir String parentDir = System.getProperty("user.dir"); String
     * resultsFolderPath = parentDir + tmpSlash + "BNGResults";
     * 
     * if (ConfigurationManager.getConfigurationManager().getOSType() == 2) { //
     * the release application on Mac String appDir = ""; if
     * (parentDir.indexOf("/Contents/MacOS") != -1) { appDir =
     * parentDir.substring(0, parentDir.indexOf("/Contents/MacOS")); appDir =
     * appDir.substring(0, appDir.lastIndexOf("/")); resultsFolderPath = appDir
     * + tmpSlash + "BNGResults"; } }
     */

    String resultsFolderPath = ConfigurationManager.getConfigurationManager()
        .getWorkspacePath()
  ...
  public static LinkHub getActionHub()
  {
    return actionHub;
  }
  ...
  /*
   * public void focusConsole() { // consoleGroup.setSelection(console);
   * 
   * }
   */
  ...
  public static void displayOutput(final String s)
  {
