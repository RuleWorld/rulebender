...
{	
	...
	private void createSShell() {
		...
		sShell.setText("BNG Editor 0.2.210");
		createToolBar();
		...
		mo1.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				// set grid layout
				fontShell.setLayout(new GridLayout(2, true));
				...
				fontcombo1.setLayoutData(gridData);
	...
	private static void checkUpdate()
	{
		...
		try 
		{
			// Create a URL
			updateFileURL =
				new URL("http://www.cs.pitt.edu/~ams292/files/bng/versions.vt");
