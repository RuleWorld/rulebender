...
public class SetWorkspaceDialogue
{
  ...
  public SetWorkspaceDialogue(final Shell mainEditorShell, BNGEditor editorIn,
      final boolean canQuit)
  {
    // Set Locals
    ...
    {
      workspacePathtext1.setText(ConfigurationManager.getConfigurationManager()
          .getWorkspacePath());
    }
    ...
    workspacePathbutton2.addSelectionListener(new SelectionListener()
    {
      ...
      public void widgetSelected(SelectionEvent arg0)
      {
        ...
        else
        {
           ...
           * 1) { ConfigurationManager.getConfigurationManager().
           * setBNGFPath(temppath.substring(0, temppath.lastIndexOf('\\')));
          ...
          ConfigurationManager.getConfigurationManager().setWorkspacePath(
              temppath);
