 ...
 */
public class RuleRenderer extends AbstractShapeRenderer
{
  ...
  protected int m_horizBorder = 5;
  protected int m_vertBorder = 5;
  protected int m_imageMargin = 5;
  ...
  /**
   * Create a new RuleRenderer. By default the field "label" is used as the
  ...
  /**
   * Create a new RuleRenderer. Draws a text label using the given text data
   * field and does not draw an image.
   * 
   * @param textField
   *          the data field for the text label.
   */
  public RuleRenderer(String textField)
  {
   ...
   *          be drawn.
   */
  public RuleRenderer(String textField, String imageField)
  {
