...
public class CMapModel
{
  ...
  /**
   * This is where components of molecules are parsed and added to the Molecule
   * data structure.
   * 
   * -ams292 5/1/10
   * 
    ...
    if (compbond.length() != 0)
    {
      while (compbond.indexOf('!') != -1)
      {
        ...
        else if (tempstr.equals("?"))
        {
          ...
          add2pbonds(
              tempstr,
              new Site(tempmp.getMoleindex(), tempcp.getCompindex(), tempcp
                  .getStateindex()));
      }
      tempstr = compbond;
      if (tempstr.indexOf('%') != -1)
