...
public class CMap extends JFrame
{
	...
	class LoadCMap
	{
		...
		LoadCMap()
		{
	        ...
	        // The Rule object that can create an edge
				...
				{	
					...
					//	if(tcomp.states.size() == 0)
							 ...
							 /*else
						{
							...
							outfile.println("} }\"];"); */
						//}  // Close else for states
					}
				}
			} // Close for each molecule
			
			//DEBUG
			comp_graph.addColumn("id", Integer.class);
			int ctr = 0 ;
			...
			{	
				...
				System.out.println("Bond Actions: ");
				...
				// TODO add states
				System.out.println("Reactant Bonds:");
				...
				System.out.println("Product Bonds: ");
				...
				//{
				//TODO Again I'm completely ignoring state as of now.
					/*if(tbond.state1 != -1)
					{
