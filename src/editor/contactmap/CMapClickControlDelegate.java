  ...
  private void nodeRightClicked(VisualItem item, MouseEvent event)
  {
    ...
    if (type.equals("state"))
    {
      ...
      if (rules == null || rules.size() == 0)
      {
        ...
        showTooltip(new ComponentTooltip((Display) event.getSource(), "State: "
        ...
        for (VisualRule rule : rules)
        {
          ...
          menuItem.addActionListener(new ActionListener()
          {
            ...
            public void actionPerformed(ActionEvent e)
            {
               ...
               * 
               * // Clear the current activeRule. if (activeRule != null) {
               * activeRule.setVisible(false); activeRule = null; }
               * 
               * // Set the active rule activeRule = source.getRule();
               * 
               * // Set the bubbles to visible activeRule.setVisible(true);
               * 
               * // Run the actions. Apparently the layout does not need // to
               * be run here... vis.run("bubbleLayout"); vis.run("bubbleColor");
               */
            }
          });
        ...
        for (VisualRule rule : rules)
        {
          ...
          menuItem.addActionListener(new ActionListener()
          {
            ...
            public void actionPerformed(ActionEvent e)
            {
               ...
               * to be run here... vis.run("bubbleLayout");
               * vis.run("bubbleColor");
               */
            }
          });
