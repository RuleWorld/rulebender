...
public class NewVersionWindow {
	...
	public static void run(Display in_display, String in_changes)
	{
	
		final String changes = in_changes;
		final Display display = in_display;// new Display();
		...
		yesButton.addListener(SWT.Selection, new Listener() {
			...
			{
				Program.launch("http://bionetgen.org/index.php/BioNetGen_Distributions");
		        System.exit(0);
			}
		});
