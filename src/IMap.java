...
public class IMap extends JFrame
{
	...
	IMap(String molestr, String rulestr, boolean moleculetype)
	{
		if(moleculetype)
	...
	void generateImap()
	{
		...
		try {//TODO : dot call problem, absolute address GUI
			...
			{
				Process p = Runtime.getRuntime().exec(BNGEditor.DOTfpath+"/"+BNGEditor.DOTfname+" -o imap.txt imap.dot");
				p.waitFor();
				Process p2 = Runtime.getRuntime().exec(BNGEditor.DOTfpath+"/"+BNGEditor.DOTfname+" -Tpng -o imap.png imap.dot");
				p2.waitFor();
			}
			else
			{
